...
final class UpdateSuratKeluarRequest extends FormRequest
{
    ...
    {
        return [
            'nomor_surat.required'   => 'Nomor surat keluar wajib diisi.',
            'nomor_surat.max'        => 'Nomor surat maksimal 100 karakter.',
            'tanggal_surat.required' => 'Tanggal surat wajib diisi.',
            'tanggal_surat.date'     => 'Format tanggal surat tidak valid.',
            'tujuan_surat.required'  => 'Tujuan surat / instansi penerima wajib diisi.',
