...
<div>
    ...
    <textarea
        ...
        {{ $required ? 'required' : '' }}
        {{ $attributes->merge([
            'class' => 'w-full px-3.5 py-2.5 text-sm text-neutral-900 bg-neutral-50/80 border rounded-xl transition duration-150 focus:outline-none focus:bg-white placeholder:text-neutral-400 leading-relaxed ' . 
            ($hasError 
