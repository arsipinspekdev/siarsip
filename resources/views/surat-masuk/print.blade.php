        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media screen {
            ...
            .info-pill {
                ...
                color: #93c5fd; padding: 5px 10px; border-radius: 8px;
...
<body>
    ...
    <div class="main-wrap">
        ...
        <aside class="settings-sidebar no-print">
            ...
            {{-- Info rekap --}}
            <div class="sidebar-section" style="background: rgba(29,78,216,.15); border-color: rgba(59,130,246,.2);">
                <div class="sidebar-section-title" style="color: #60a5fa;">
                    ...
                    Info Rekap <span style="border-color: rgba(96,165,250,.2);"></span>
                </div>
                <p style="font-size: 12px; color: #93c5fd; font-weight: 600;">
                    Total: {{ $items->count() }} Surat Masuk
                </p>
                @if(!empty($search))
                    <p style="font-size: 11px; color: #7dd3fc; margin-top: 4px;">
                        Filter: "{{ $search }}"
                    </p>
                @endif
            </div>
        ...
        <main class="preview-area">
            ...
            <div class="paper-sheet">
                ...
                {{-- JUDUL --}}
                <div class="doc-title">REKAPITULASI ARSIP SURAT MASUK</div>
